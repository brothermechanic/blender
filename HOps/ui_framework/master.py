...
class Master():
    ...
    def receive_main(self, win_dict={}, window_name="MAIN"):
        ...
        if Modal_Communications.coms[self.unique_id].preset_ref != None:
            Modal_Communications.coms[self.unique_id].preset_ref.build_main(win_dict=win_dict, window_name=window_name)
    ...
    def receive_mod(self, win_dict={}, active_mod_name=""):
        ...
        if Modal_Communications.coms[self.unique_id].preset_ref != None:
            Modal_Communications.coms[self.unique_id].preset_ref.build_mods(win_dict=win_dict, active_mod_name=active_mod_name)
