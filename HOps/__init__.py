...
bl_info = {
    "name": "Hard Ops 9",
    "description": "Hard Ops 9 - NeodymiumX",
    ...
    "wiki_url": "https://masterxeon1001.com/2019/09/01/hard-ops-00983-update-log/",
    "category": "3D View"}
...
from .operators.modifiers import simple_deform, triangulate, weighted_normal, wireframe, displace, subsurf, screw, weld, lattice, decimate, Apply_modfiers, shrinkwrap, skin, cast, mask, hook, smooth, l_smooth, third_party
...
from .operators.modals.kit_ops import *
...
classes = (
    ...
    HOPS_OT_ArrayMinus,
    HOPS_OT_ArrayPlus,
    third_party.HOPS_OT_TP_PowerSaveInt,
