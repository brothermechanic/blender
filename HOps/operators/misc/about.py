...
class HOPS_OT_About(bpy.types.Operator):
    ...
    HOps: {bl_info['version'][1]}.{bl_info['version'][2]}{bl_info['version'][3]}.{bl_info['version'][4]}\n
    {bl_info['description']}
    '''
    called_ui = False
        ...
        if event.shift:
            if not HOPS_OT_About.called_ui:
                ...
                draw_data = [
                    ...
                    [f"HOps: {bl_info['version'][1]}.{bl_info['version'][2]}{bl_info['version'][3]}.{bl_info['version'][4]}", " "]]
