...
class HOPS_OT_EntrenchOperatorA(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        bpy.ops.mesh.extrude_region_move(MESH_OT_extrude_region={"mirror":False}, TRANSFORM_OT_translate={"value":(0, 0, 0), "constraint_axis":(False, False, False)})
        bpy.ops.transform.shrink_fatten(value=0.04, use_even_offset=True, mirror=False,proportional_edit_falloff='SMOOTH', proportional_size=1)
...
class HOPS_OT_PanelOperatorA(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        bpy.ops.mesh.select_less()
        bpy.ops.transform.shrink_fatten(value=0.0288466, use_even_offset=False, mirror=True, use_proportional_edit=False, proportional_edit_falloff='SMOOTH', proportional_size=1, use_proportional_connected=False, use_proportional_projected=False)
