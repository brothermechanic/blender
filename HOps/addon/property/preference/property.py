...
class hops(PropertyGroup):
    ...
    ko_popup_type: EnumProperty(name="KitOps Popup Type",
                                 description="Kitops popup toggle for ST3 or classic",
                                 items=[("DEFAULT", "Default", ""),
                                 ("ST3", "St3", "")],
                                 default='ST3')

    menu_array_type: EnumProperty(name="Array Q Menu Option Type",
                                  description="HOPS array style for Q menus",
                                  items=[("DEFAULT", "Default", ""),
                                  ("ST3", "St3", "")],
                                  default='ST3')

    array_type: EnumProperty(name="ST3 Gizmo Type",
                                description="ST3 Circle / DOT",
                                items=[
                                    ("CIRCLE", "Circle", ""),
                                    ("DOT", "Dot", "")],
                                default='CIRCLE')
    ...
    Hops_twist_radial_sort: BoolProperty(
        ...
        default=False,
        description="Bypasses sort bypass / edit display on twist / radial 360")
    ...
    parent_boolshapes: BoolProperty(name="Parent Boolshapes", default=False)
...
def draw(preference, context, layout):
    ...
    label_row(preference.property, 'to_cam_jump', layout.row(), label='Jump To_Cam')
    ...
    label_row(preference.property, 'sharp_use_crease', layout.row(), label='Mark Crease')
    label_row(preference.property, 'sharp_use_bweight', layout.row(), label='Mark Bevel Weight')
    label_row(preference.property, 'sharp_use_seam', layout.row(), label='Mark Seam')
    label_row(preference.property, 'sharp_use_sharp', layout.row(), label='Mark Sharp')
    layout.separator()
    ...
    if get_preferences().property.debug:
        ...
        label_row(preference.property, 'Hops_sharp_remove_cutters', layout.row(), label='Sharpen Remove Cutters')
