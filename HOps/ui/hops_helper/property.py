...
def context_items2(pg, context):
    ...
    if context.active_object:
        if len([mod for mod in context.active_object.modifiers if mod.type == 'BEVEL']):
            items.append(('BEVEL_HELPER', 'Bevel Helper', 'Mod Helper', icon.id('CSharpen'), 4))

    items.append(('HELP', 'Help', 'HOps Help', 'URL', 5))
