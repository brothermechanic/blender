...
weblinks = [
    ...
    ("Version 9 Release Log",   "https://masterxeon1001.com/2019/09/01/hard-ops-00983-update-log/"),
    ...
    ("Box Cutter Latest Guide", "https://masterxeon1001.com/2019/07/10/boxcutter-713-release-notes/")
]
...
class HOPS_OT_InsertsPopupPreview(bpy.types.Operator):
    """
    LMB - DM / KO Insert Popup Window
    Shift - DM / KO Insert Popup Persistent (ST3 only)
