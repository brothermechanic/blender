...
class HOPS_OT_ADD_sphere(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        self.add_bevel_modifier(obj, verts=False, segments=16, width=15, clamp=True, angle=30, profie=0.5, name='HOPS_bevel_c')
    ...
    def add_bevel_modifier(self, object, verts, segments, width, clamp, angle, profie, name='HOPS_bevel_c'):
