...
CTRL - Planar Smart Box
    ...
    def invoke(self, context, event):
        ...
        if event.ctrl:
            self.add_bevel_modifier(obj, True, 1, 0.2, True, 30, 'HOPS_bevel_d')
        else:
            self.add_bevel_modifier(obj, True, 12, 0.2, True, 30, 'HOPS_bevel_d')
        if (2, 82, 4) < bpy.app.version:
            self.add_weld_modifier(obj, 'HOPS_weld')
        self.add_solidify_modifier(obj, 'HOPS_solidify_z')
        if event.ctrl:
            self.add_bevel_modifier(obj, False, 1, 0.07, True, 60, 'HOPS_bevel_b')
        else:
            self.add_bevel_modifier(obj, False, 1, 0.07, True, 30, 'HOPS_bevel_b')
        if (2, 82, 4) < bpy.app.version:
            self.add_weld_modifier(obj, 'HOPS_weld')
        self.add_bevel_modifier(obj, False, 6, 0.005, False, 30, 'HOPS_bevel_c')
    ...
    def add_bevel_modifier(self, object, verts, segments, width, clamp, angle, name='HOPS_bevel_c'):
