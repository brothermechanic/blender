...
from . import active_tool, addon, object, modifier
...
def user_sort(obj):
    ...
    bevs = bevels(obj, vertex_group=ignore_vgroup, props={'use_only_vertices': True} if ignore_verts else {})
...
#     if get_preferences().property.sort_modifiers or force:

#         mod_types = []
#         if get_preferences().property.sort_bevel and not get_preferences().property.sort_bevel_last: mod_types.append('BEVEL')
#         if get_preferences().property.sort_array: mod_types.append('ARRAY')
#         if get_preferences().property.sort_mirror: mod_types.append('MIRROR')
#         if get_preferences().property.sort_solidify: mod_types.append('SOLIDIFY')
#         if get_preferences().property.sort_weighted_normal: mod_types.append('WEIGHTED_NORMAL')
#         if get_preferences().property.sort_simple_deform: mod_types.append('SIMPLE_DEFORM')
#         if get_preferences().property.sort_triangulate: mod_types.append('TRIANGULATE')
#         if get_preferences().property.sort_decimate: mod_types.append('DECIMATE')
...
#         sort_bevel = get_preferences().property.sort_bevel
#         sort_last_bevel = get_preferences().property.sort_bevel_last
...
#             bgroup = mod.type == 'BEVEL' and mod.limit_method == 'VGROUP'
